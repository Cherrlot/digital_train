  ...
  renderTitleInput() {
    return (widget.needTitle)
        ...
        child: new GSYInputWidget(
          ...
          hintText:
          StringConstant.issue_edit_issue_title_tip,
          obscureText: false,
        ))
        : new Container();
  }
                          ...
                          new Padding(
                              ...
                              child: new Center(
                                child: new Text(widget.dialogTitle,
                                    style: TextStyle(
                                      color: ColorConstant.primaryDarkValue,
                                      fontSize: 18.sp,
                          ...
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                              ...
                              border: new Border.all(
                                  color: ColorConstant.subTextColor, width: .3),
                            ),
                                ...
                                new Expanded(
                                  child: new TextField(
                                    ...
                                    decoration: new InputDecoration(
                                      hintText: StringConstant.issue_edit_issue_title_tip,
                                      hintStyle: TextStyle(
...
var FAST_INPUT_LIST = [
  FastInputIconModel(ImageConstant.ISSUE_EDIT_H1, "\n# "),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_H2, "\n## "),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_H3, "\n### "),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_BOLD, "****"),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_ITALIC, "__"),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_QUOTE, "` `"),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_CODE, " \n``` \n\n``` \n"),
  FastInputIconModel(ImageConstant.ISSUE_EDIT_LINK, "[](url)"),
];
